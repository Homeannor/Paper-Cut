...
[RequireComponent(typeof(AudioSource))] // Require an AudioSource component
[RequireComponent(typeof(BoxCollider))] // Require a BoxCollider component
public class Collectable : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        gameReset = GameObject.Find("GameManager").GetComponent<GameReset>();
    }
